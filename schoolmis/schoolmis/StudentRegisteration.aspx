<%@ Page Title="" Language="C#" MasterPageFile="~/adminDashboard.Master" AutoEventWireup="true" CodeBehind="StudentRegisteration.aspx.cs" Inherits="schoolmis.StudentRegisteration" %>
        ...
        <div class="row">
            <form runat="server">
                ...
                <div class="form-outline mb-4">
                    ...
                    <asp:DropDownList ID="entrystatusddl" runat="server" CssClass="btn btn-secondary " Height="34px" Width="394px"></asp:DropDownList><br />
                    <label class="form-label" for="entrystatusddl">Select Entry Status</label>
