<%@ Page Title="" Language="C#" MasterPageFile="~/dashboard.Master" AutoEventWireup="true" CodeBehind="UserDetails.aspx.cs" Inherits="schoolmis.UserDetails" %>
                ...
                <div class="row mb-4">
                    <div class="col">
                        <div class="form-outline">
                            <label class="form-label" for="nameLbl">ID:</label>
                            <asp:Label ID="idTxt" runat="server" Text=""></asp:Label>
